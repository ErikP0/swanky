...
fn build_photon_circuit(poly: &Modulus, z: &[u16], ics: &[u16], d: usize) -> Circuit {
    let mut b = CircuitBuilder::new();
        let x = b.photon_garbler_input(poly, d); 
...
fn main() {
    ...
    let circ = build_photon_circuit(x4_x_1, z, ics, 5);
